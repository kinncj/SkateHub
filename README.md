...
An OpenSource skate peak sharing tool for skaters
Requirements
------------
...
* APPLICATION_DB_HOST: The host to connect
* APPLICATION_DB_USER: Username used to connect to the databse
* APPLICATION_DB_PASSWD: Password of the before mentioned username
* APPLICATION_DB_NAME: The database name that are going to be used
* APPLICATION_DB_DRIVER: The [php extension](http://br2.php.net/manual/en/refs.database.php) that are going to be used for connection
